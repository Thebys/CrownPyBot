...
def advance_conversation(Conversation, Max_Completion_Tokens=1024, Temperature=0.25, Top_p=0.9):
    ...
    if (expected_length > config.OPENAI_CHAT_MODEL_MAX_TOKENS):
        ...
        return Conversation.add_message(ai_response["choices"][0]["message"])
